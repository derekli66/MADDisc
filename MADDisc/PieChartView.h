...
@protocol FNCPieGraphDelegate <NSObject>
...
@interface PieChartView : UIView {	
    ...
    id <FNCPieGraphDelegate> delegate;
}
@property (nonatomic, retain) id delegate;

- (void)clearItems;
- (void)addItemValue:(CGFloat)value withColor:(PieChartItemColor)color;
...
@interface PieChartView (FNCPieGraphController)
